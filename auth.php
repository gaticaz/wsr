...
class auth_plugin_wsr extends auth_plugin_base
{
     ...
     * @param bool $doupdates  Opcional: poner a true para forzar una actualización de cuentas existentes
    ...
    /**
     * La información del usuario se gestiona externamente.
     *
    ...
    /**
     * Encriptar contraseña para autenticación WSR.
     *
